...
return [
    ...
    'refereeManagement'                       => [
        ...
        'title_singular' => 'Referee Management',
        'fields'         => [],
    ],
    'bookedEvent'                       => [
        'title'          => 'Booked Event',
        'title_singular' => 'Booked Event',
        'fields'         => [],
    ],
    'manualNotifications'                       => [
        'title'          => 'Manual Notifications',
        'title_singular' => 'Manual Notifications',
        'fields'         => [],
    ],
    'supportSection'                       => [
        'title'          => 'Support Section',
        'title_singular' => 'Support Section',
        'fields'         => [],
    ],
    'walletManagement'                       => [
    ...
    'referee'                              => [
        ...
        'fields'         => [
            ...
            'generate_password_helper'        => '',
            'gender'               => 'Gender',
            'gender_helper'        => '',
            'age'               => 'Age',
            'age_helper'        => '',
            'details'               => 'Details (Expereinece + Education)',
            'details_helper'        => '',
            'address'               => 'Address',
            'address_helper'        => '',
            'pincode'        => 'PinCode',
