...
Route::group(['middleware' => ['auth:api']], function () {
   ...
   // Route::group(['middleware' => ['verifyemail']], function() {
        ...
        Route::get('get-event-leaderboard/{event_id}/{sub_event_id?}/{specified_id?}', 'Api\LeaderBoardsApiController@getEventLeaderBoard');
        ...
        Route::post('submit-final-athlete-score-by-event-creator', 'Api\RefereesApiController@submitFinalAthleteScoreByEventCreator');
